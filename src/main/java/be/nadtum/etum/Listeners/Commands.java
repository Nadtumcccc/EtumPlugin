...
import be.nadtum.etum.Vanilla.Economie.commands.command_mana;
...
public class Commands {
    public Commands(Main main) {
        ...
        main.getCommand("claim").setExecutor(new command_claim());
        main.getCommand("unclaim").setExecutor(new command_claim());
